...
"""
Abalation_Study.test_experiment(data= data,alphas=20)
...
"""
Abalation_Study.test_synthetic_features(data_size = 10000, feature_size =[9,10,11],folds=3, alphas=10, range=100,solver='lasso')
